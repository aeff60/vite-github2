        ...
        <div>
            ...
            <Box sx={{display: 'flex', flexDirection: { xs: 'column', md: 'row'}, justifyContent: 'space-evenly', backgroundColor: '#333'}}>
                <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', order: { xs: 2, md: 1 }}}>
                    <Typography variant='h3' fontWeight= 'bold' gutterBottom>Machine Learning</Typography>
                    <Typography variant='subtitle1' fontWeight= 'bold' gutterBottom>To be master of MachineLearning in 20 minutes</Typography>
                    <RatingC />
                </Box>
                ...
                <Grid container spacing={2} columns={12} sx={{ my: 20}}>
                                ...
                                <Accordion sx={{ background: '#333'}}>
                                    ...
                                    <AccordionDetails>
                                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                                            <Typography sx={{ color: '#fff' }}>Introduction to MachineLearning</Typography>
                    ...
                    <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }} maxWidth= 'md'>
                        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', my: 2 }}>
                            <Typography variant='h5' fontWeight= 'bold' gutterBottom>Welcome to Machine Learning</Typography>
                        </Box>
