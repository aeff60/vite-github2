        ...
        <div>
            ...
            <Box sx={{display: 'flex', flexDirection: { xs: 'column', md: 'row'}, justifyContent: 'space-evenly', backgroundColor: '#333'}}>
                <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', order: { xs: 2, md: 1 }}}>
                    <Typography variant='h3' fontWeight= 'bold' gutterBottom>Intro To Python</Typography>
                    <Typography variant='subtitle1' fontWeight= 'bold' gutterBottom>To be master of Python in 20 minutes</Typography>
                    <RatingC />
                </Box>
                ...
                <Grid container spacing={2} columns={12} sx={{ my: 20}}>
                        ...
                        <Container sx={{marginTop: 1}} maxWidth= 'md'>
                            ...
                            <Box>
                                <Accordion sx={{ background: '#333' }}>
                                    ...
                                    <AccordionDetails>
                                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                                            <Typography sx={{ color: '#fff', flexGrow: 1 }}>Introduction to Python</Typography>
                                            <Typography sx={{ color: '#fff', border: 1, borderRadius: '16px', padding: '1px 5px', margin:'0 10px' }}>20 mins</Typography>
                                            <FinishIcon />
                                        </Box>
                                    </AccordionDetails>
                                </Accordion>
                                <Accordion sx={{ background: '#333' }}>
                                    ...
                                    <AccordionDetails>
                                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                                            <Typography sx={{ color: '#fff' }}>Introduction to Python</Typography>
                    ...
                    <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }} maxWidth= 'md'>
                        <Box sx={{ display: 'flex', justifyContent: 'center', my: 2 }}>
                            <Typography variant='h4' fontWeight= 'bold' gutterBottom>Welcome to Python</Typography>
                        </Box>
                        <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <Button sx={{ mb: '2rem', fontWeight: 'bold'}} variant='contained' size='large' href='/chapter1'>Start</Button>
